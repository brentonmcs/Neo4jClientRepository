...
namespace Neo4jClientRepository
{
    ...
    public interface INeo4jRelatedNodes<TNode, TTargetNode>   
    {
        ...
        void AddRelatedRelationship<TData>(Node<TNode> source, Node<TTargetNode> target, TData properties)
            where TData : class, IPayload, new();
         
        void AddRelatedRelationship<TData>(string source, string target, TData properties)
            where TData : class, IPayload, new();
        ...
        IEnumerable<RelationshipInstance<TData>> GetRelationships<TData>() 
            where TData : class, IPayload, new();
